...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS delta.`/mnt/silver/providers` (
...
# MAGIC %sql
# MAGIC truncate table delta.`/mnt/silver/providers`

# COMMAND ----------

# MAGIC %sql 
# MAGIC insert into delta.`/mnt/silver/providers`
# MAGIC select 
# MAGIC distinct
# MAGIC ProviderID,
# MAGIC FirstName,
...
# MAGIC %sql
# MAGIC SELECT * FROM DELTA.`/mnt/silver/providers`
