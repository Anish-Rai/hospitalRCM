...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS delta.`/mnt/silver/cptcodes` (
...
silver_cptcodes_df = spark.read.format("delta").load("/mnt/silver/cptcodes")

# Register the Silver Layer data as a temporary SQL view for SQL operations
silver_cptcodes_df.createOrReplaceTempView("silver_cptcodes")
...
# MAGIC %sql
# MAGIC select * from delta.`/mnt/silver/cptcodes`;
