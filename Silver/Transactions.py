...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS DELTA.`/mnt/silver/transactions` (
...
silver_transactions_df = spark.read.format("delta").load("/mnt/silver/transactions")
silver_transactions_df.createOrReplaceTempView("silver_transactions")
...
# MAGIC %sql
# MAGIC SELECT * FROM DELTA.`/mnt/silver/transactions` LIMIT 10
