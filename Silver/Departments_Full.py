...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS DELTA.`/mnt/silver/departments` (
...
# MAGIC %sql 
# MAGIC truncate table DELTA.`/mnt/silver/departments`

# COMMAND ----------

# MAGIC %sql
# MAGIC insert into DELTA.`/mnt/silver/departments`
# MAGIC SELECT 
# MAGIC Dept_Id,
# MAGIC SRC_Dept_Id,
# MAGIC Name,
...
# MAGIC %sql
# MAGIC select * from DELTA.`/mnt/silver/departments` LIMIT 10
