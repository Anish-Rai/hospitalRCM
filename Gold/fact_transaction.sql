...
create table if not exists delta.`/mnt/gold/fact_transactions`
(
...
truncate table delta.`/mnt/gold/fact_transactions`

-- COMMAND ----------

insert into delta.`/mnt/gold/fact_transactions`
select 
  t.TransactionID, 
  t.SRC_TransactionID,
  t.EncounterID,
  ...
  t.datasource,
  current_timestamp()
  from delta.`/mnt/silver/transactions` t 
